...
<head>
    ...
    <title>Add Friends - <?php echo htmlspecialchars($user['name']); ?> - Manexis</title>
    <link rel="stylesheet" href="../assets/css/style.css">
    <style>
        /* Add Friends Specific Styles */
...
<body class="dashboard-page">
    ...
    <script>
        // Enhanced Add Friends JavaScript
        document.addEventListener('DOMContentLoaded', function() {
            // Add confirmation for friend requests
            ...
            setTimeout(() => {
                document.querySelectorAll('.message').forEach(msg => {
                    if (msg.classList.contains('msg-success') || msg.classList.contains('msg-error') || msg.classList.contains('msg-info')) {
                        msg.style.opacity = '0';
            ...
            if (searchForm) {
                ...
                tip.style.cssText = 'color: #718096; font-size: 14px; margin-top: 10px; text-align: center;';
                tip.textContent = '💡 Tip: Search by full name or email address for best results';
                searchForm.parentNode.appendChild(tip);
            }
        });
    </script>
</body>
